package com.lx.springboot.springbootmybatis.configuration;
...
*/  
public class DruidDateSourceConfig implements EnvironmentAware{
    ...
    public ServletRegistrationBean druidServlet() {  
        ...
        initParameters.put("loginUsername", "lixiong");// 用户名  
